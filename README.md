...
*Read this in [English](https://www.google.com/search?q=%23bachelors-thesis-complex-dynamics--rational-functions).*
...
Para ejecutar el código e interactuar con los cuadernos de Jupyter, necesitarás un entorno de Python. La forma más sencilla de configurarlo es usando [Conda](https://www.google.com/search?q=https://docs.conda.io/en/latest/miniconda.html).
...
2. **Crear un entorno de Conda e instalar las dependencias:**  
...
*Read this in [Spanish / Leer en Español](https://www.google.com/search?q=%23tesis-de-grado-din%C3%A1mica-compleja-y-funciones-racionales-espa%C3%B1ol).*
...
To run the code and interact with the Jupyter notebooks, you will need a Python environment. The easiest way to set this up is using [Conda](https://www.google.com/search?q=https://docs.conda.io/en/latest/miniconda.html).
